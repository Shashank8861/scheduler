        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'createnew',
              path: 'createnew',
              builder: (context, params) => CreatenewWidget(),
            ),
            FFRoute(
              name: 'viewdetails',
              path: 'viewdetails',
              builder: (context, params) => ViewdetailsWidget(
                desc: params.getParam('desc', ParamType.String),
                name: params.getParam('name', ParamType.String),
                starttime: params.getParam('starttime', ParamType.String),
                endtime: params.getParam('endtime', ParamType.String),
