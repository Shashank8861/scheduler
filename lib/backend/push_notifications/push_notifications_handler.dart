...
final pageBuilderMap = <String, Future<Widget> Function(Map<String, dynamic>)>{
  ...
  'createnew': (data) async => CreatenewWidget(),
  'viewdetails': (data) async => ViewdetailsWidget(
        desc: getParameter(data, 'desc'),
        name: getParameter(data, 'name'),
        starttime: getParameter(data, 'starttime'),
        endtime: getParameter(data, 'endtime'),
